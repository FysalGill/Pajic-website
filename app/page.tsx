...
export default function Page() {
  ...
  return <>
    <style>{`\n      .holding{background:#f7f5ef;color:#090909}.holding .eyebrow{color:#b89450;text-shadow:none}.holdingIntro{display:grid;grid-template-columns:minmax(0,1.2fr) minmax(280px,.8fr);gap:70px;align-items:end}.holdingIntro h2{max-width:720px}.holdingIntro>p{margin:0 0 5px;color:#5b5750;font-size:15px;line-height:1.55}.holdingGrid{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:1px;background:rgba(120,95,45,.28);border:1px solid rgba(120,95,45,.28);margin-top:58px}.holdingLogo{height:250px;background:#fff;display:flex;align-items:center;justify-content:center;padding:30px;transition:background .25s ease,transform .25s ease}.holdingLogo img{width:100%;height:100%;object-fit:contain;display:block;filter:saturate(.9)}.holdingLogo:hover{background:#f4efe4;transform:translateY(-2px);position:relative;z-index:2}.holdingLogo:hover img{filter:saturate(1.02)}\n      @media(max-width:900px){.holdingIntro{grid-template-columns:1fr;gap:24px}.holdingGrid{grid-template-columns:repeat(2,minmax(0,1fr));margin-top:42px}.holdingLogo{height:220px;padding:24px}}\n      @media(max-width:560px){.holdingGrid{grid-template-columns:1fr}.holdingLogo{height:220px}}\n\n      /* Uniform section system: use the contact section as the reference frame. */\n      .section:not(.hero){min-height:600px;display:flex;align-items:center;width:100%;}\n      .section:not(.hero)>.wrap{width:min(1240px,90vw);margin-left:auto;margin-right:auto;}\n      .wrap.section{width:100%;max-width:none;}\n      .wrap.section>.split,.wrap.section>.imageStrip{width:min(1240px,90vw);margin-left:auto;margin-right:auto;}\n      .dark.section,.lab.section,.press.section,.contact.section{width:100%;}\n      .feature{width:100%;max-width:none;min-height:600px;}\n      .featureImg,.featureCopy{min-height:600px;}\n      .featureImg{display:flex;align-items:center;}\n      .featureImg img{width:100%;height:100%;min-height:460px;object-fit:cover;}\n      .thesisGrid{width:100%;}\n      .thesisTile{height:300px;min-height:300px;}\n      .mapCard{height:300px;min-height:300px;}\n      .portfolio article{height:340px;min-height:340px;}\n      .insights .article{height:360px;min-height:360px;}\n      .article img{height:185px;min-height:185px;}\n      .holdingGrid{width:100%;}\n      .holdingLogo{height:220px;min-height:220px;}\n      .pressCard{width:100%;}\n      .contact{min-height:600px;}\n\n      @media(max-width:900px){\n        .section:not(.hero){min-height:600px;}\n        .feature,.featureImg,.featureCopy{min-height:600px;}\n        .featureImg img{height:400px;min-height:400px;}\n        .thesisTile,.mapCard{height:270px;min-height:270px;}\n        .portfolio article{height:330px;min-height:330px;}\n        .insights .article{height:auto;min-height:360px;}\n      }\n      @media(max-width:560px){\n        .section:not(.hero){min-height:600px;}\n        .feature,.featureImg,.featureCopy{min-height:600px;}\n        .featureImg img{height:330px;min-height:330px;}\n        .thesisTile,.mapCard{height:260px;min-height:260px;}\n        .portfolio article{height:320px;min-height:320px;}\n        .insights .article{height:auto;min-height:360px;}\n        .holdingLogo{height:210px;min-height:210px;}\n      }\n    `}</style>
